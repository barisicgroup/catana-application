...
import PluginLoader from '../catana/loader/plugin-loader'
import {
  DatasourceRegistry, DecompressorRegistry, ParserRegistry, PluginExtension, ScriptExtensions
} from '../globals'
...
export function autoLoad(file: LoaderInput, params: Partial<LoaderParameters> = {}) {
  ...
  } else if (PluginExtension === p.ext) {
    loader = new PluginLoader(p.src, p);
  }
