...
class KeyControls {
  ...
  run (key: string) {
    ...
    // Catana addition: Allow KeyActions/CatanaActions to prevent default key events
    if (KeyActions.keyDown(this.stage, key)) return;
   ...
   * stage.keyControls.add( "k", KeyActions.toggleRock );
   *
