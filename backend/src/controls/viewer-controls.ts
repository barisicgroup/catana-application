...
class ViewerControls {
  signals = {
    ...
    freezeStateChanged: new signalsWrapper.Signal()
  }
  ...
  set isFreezed(newState: boolean) {
    if (newState !== this.isFreezed) {
      this._isFreezed = newState;
      this.signals.freezeStateChanged.dispatch();
    }
  }
