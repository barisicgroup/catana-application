...
export const Log = {
  eventListeners: [] as { (type: "log" | "info" | "warn" | "error", ...argArray: any[]): void }[],
  log: (...argArray: any[]) => {
    Function.prototype.bind.call(console.log, console)(...argArray);
    Log.eventListeners.forEach(ev => ev("log", ...argArray));
  },
  info: (...argArray: any[]) => {
    Function.prototype.bind.call(console.info, console)(...argArray);
    Log.eventListeners.forEach(ev => ev("info", ...argArray));
  },
  warn: (...argArray: any[]) => {
    Function.prototype.bind.call(console.warn, console)(...argArray);
    Log.eventListeners.forEach(ev => ev("warn", ...argArray));
  },
  error: (...argArray: any[]) => {
    Function.prototype.bind.call(console.error, console)(...argArray);
    Log.eventListeners.forEach(ev => ev("error", ...argArray));
  },
 ...
 */
export const JsScriptExtensions = ["ngl", "js"]
export const JsPyScriptExtensions = ["jspy"]
export const ScriptExtensions = [...JsScriptExtensions, ...JsPyScriptExtensions]
export const PluginExtension = "catplg";
...
// Catana
export const CoarseGrainedRepresentationRegistry = new Registry("cg-representation");
export const ParserParametersRegistry = new Registry("parser-parameters");
export const ExampleRegistry = new Registry("example-registry");
