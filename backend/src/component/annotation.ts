...
export default class Annotation {
   ...
   */
  constructor(readonly component: Component, position: Vector3, content: string | HTMLElement, params: AnnotationParams = {}) {
    ...
    this.applyFog = defaults(params.applyFog, true)
