...
// nucleobase types
export const UnknownNucleobaseType = 0
export const PurineNucleobaseType = 1
export const PyrimidineNucleobaseType = 2
...
export const NA1: { [k: string]: string } = {
  'DA': 'A',
  'A' : 'A',
  'DC': 'C',
  'C' : 'C',
...
export const NucleicBackboneAtoms = [
  ...
  'O2*', 'O3*', 'O4*', 'O5*', 'C1*', 'C2*', 'C3*', 'C4*', 'C5*',
  'O1P', 'O2P' // Catana extension to handle non-standard atom names
]

export const NucleobaseTypeAtoms: { [k: number]: { [k: string]: string | string[] } } = {}

NucleobaseTypeAtoms[UnknownNucleobaseType] = {}

NucleobaseTypeAtoms[PurineNucleobaseType] = {
  baseNames: ['A', 'G', 'I', 'DA', 'DG', 'DI'],
  commonNitrogens: ['N1', 'N3', 'N7', 'N9'],
  minorGrooveSide: ['C2', 'N3', 'C4', 'N9'],  // Some atoms which lie on the minor groove side of the nucleobase
  majorGrooveSide: ['N7', 'C6']               // Some atoms which lie on the major groove side of the nucleobase
}

NucleobaseTypeAtoms[PyrimidineNucleobaseType] = {
  baseNames: ['C', 'T', 'U', 'DC', 'DT', 'DU'],
  commonNitrogens: ['N1', 'N3'],
  minorGrooveSide: ['N1', 'C2'],
  majorGrooveSide: ['C4', 'C5']
}
...
ResidueTypeAtoms[CgRnaBackboneType] = {
  trace: ["C4'", 'C4*', 'P', "BB1", "BB2", "BB3"], // BB(1/2/3) are used by martini c-g force field
  backboneStart: ["C4'", 'C4*', 'P', "BB1"],
  backboneEnd: ["C4'", 'C4*', 'P', "BB3"]
}

ResidueTypeAtoms[CgDnaBackboneType] = {
  trace: ["C3'", 'C3*', "C2'", 'P', "BB1", "BB2", "BB3"],  // C2' is used in martini ff
  backboneStart: ["C3'", 'C3*', "C2'", 'P', "BB1"],
  backboneEnd: ["C3'", 'C3*', "C2'", 'P', "BB3"]
}
