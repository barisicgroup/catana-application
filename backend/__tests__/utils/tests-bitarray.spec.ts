...
import BitArray_Legacy from '../../src/utils/bitarray'
...
describe('utils/bitarray', function () {
  describe('BitArray', function () {
    ...
    it('sele string', function () {
      ...
      expect(ba.toFiltString()).toEqual('NONE')

      ba.set(10)
      expect(ba.toFiltString()).toEqual('@10')

      ba.set(2)
      ba.set(36)
      expect(ba.toFiltString()).toEqual('@2,10,36')
    })
    ...
    it('set all 140', function () {
      var ba = new BitArray_Legacy(140)
    ...
    it('clone', function () {
      var ba = new BitArray_Legacy(40)
      var bac = ba.clone()
      expect(bac instanceof BitArray_Legacy).toBeTruthy()
    ...
    it('union', function () {
      var ba = new BitArray_Legacy(40)
      var bb = new BitArray_Legacy(40)
      var bc = new BitArray_Legacy(40)
      ...
      ba.union(bb)
      expect(ba instanceof BitArray_Legacy).toBeTruthy()
